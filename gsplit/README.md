...
Gsplit получен с [github](https://github.com/Salat39/GSplit/releases). Я брал релиз *-other.
 ...
 3. Включаем в ГУ adb [инструкция](https://github.com/burutus1/T1/blob/main/doc/README.md). Подключаем проводок от компьютера в верхний левый порт. Обновляем, если надо, [драйвер ADB](https://github.com/burutus1/T1/tree/main/update_driver#readme) на компьютере. Соглашаемся на покдлючение adb.
