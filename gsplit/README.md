...
Gsplit получен с [github](https://github.com/Salat39/GSplit/releases). Я брал релиз *-other.
 ...
 1. Предполагаю, что на ГУ уже есть какой-нибудь лаунчер (панель) запуска приложений, типа Panels или Everywhere Launcher (мой случай).
 ...
 3. Включаем в ГУ adb [по инструкции](https://github.com/burutus1/T1/blob/main/doc/README.md). Подключаем проводок USB от компьютера в верхний левый порт. Обновляем, если надо, [драйвер ADB](https://github.com/burutus1/T1/tree/main/update_driver#readme) на компьютере. Соглашаемся на покдлючение adb.
...
# Загрузка настроек DSP из файла на ГУ
 1. Размещаем файл **audiotuning_sony.json** (это и есть настройки звука) в каталог /sdcard/ на ГУ (через adb командный файл send_json.cmd)\
 ![файл в корне sdcard](img/07_fileman_sony.jpg)
 2. Запускаем приложение **MediaDebug** (я добавил его себе на выезжающую панель) давим на кнопки как на картинке:
